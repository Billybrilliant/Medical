    ...
    return (
      <div className="introduceD-box">
        ...
        <div className="container idoc-jianjie">
          ...
          <p>2016年毕业西安交通大学，获得临床医学博士学位，同年工作于西安交通大学第二附属医院骨科至今</p>
        ...
        <div className="container idoc-hosmsg">
          ...
          <div className="row">
            <img src="../../../assets/images/icon-idoc/hospital.png" alt="医院" />
            <p>西安交通大学医学院第二附属医院</p>
          </div>
          <div className="row">
            <img src="../../../assets/images/icon-idoc/phone.png" alt="电话" />
            <p>联系电话：029-86868686</p>
          </div>
          <div className="row">
            <img src="../../../assets/images/icon-idoc/address.png" alt="地址" />
            <p>陕西省西安市西五路157号</p>
          </div>
        </div>
          ...
          <div className="row">
            ...
            <div className="yuyue-time">
              <table className="text-center">
                <tbody>
                  <tr>
                    <td className="tab-first" width="80px" >日期</td>
